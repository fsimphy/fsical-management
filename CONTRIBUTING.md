# Contributing to fsical-management
...
- **Did the problem start happening recently** (e.g. after updating to a new version of fsical-management) or was this always a problem?
